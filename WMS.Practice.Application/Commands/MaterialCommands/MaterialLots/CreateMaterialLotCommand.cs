...
{
    public class CreateMaterialLotCommand : IRequest<bool>
    {
        ...
        public CreateMaterialLotCommand(string lotNumber, string lotStatus, string materialId, double exisitingQuantity, List<CreateMaterialLotPropertyCommand> properties, List<CreateMaterialSubLotCommand> subLots)
        {
            LotNumber = lotNumber;
            LotStatus = lotStatus;
